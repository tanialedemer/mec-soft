...
class ComprasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create compra" do
    assert_difference('Compra.count') do
      post compras_url, params: { compra: { fecha: @compra.fecha, num_fact: @compra.num_fact, pago: @compra.pago, proveedor_id: @compra.proveedor_id, saldo: @compra.saldo, tipo_factura_id: @compra.tipo_factura_id, total: @compra.total } }
    end
  ...
  test "should update compra" do
    patch compra_url(@compra), params: { compra: { fecha: @compra.fecha, num_fact: @compra.num_fact, pago: @compra.pago, proveedor_id: @compra.proveedor_id, saldo: @compra.saldo, tipo_factura_id: @compra.tipo_factura_id, total: @compra.total } }

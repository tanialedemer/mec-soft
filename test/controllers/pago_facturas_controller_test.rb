...
class PagoFacturasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pago_factura" do
    assert_difference('PagoFactura.count') do
      post pago_facturas_url, params: { pago_factura: { compra_id: @pago_factura.compra_id, monto_pago: @pago_factura.monto_pago } }
    end
  ...
  test "should update pago_factura" do
    patch pago_factura_url(@pago_factura), params: { pago_factura: { compra_id: @pago_factura.compra_id, monto_pago: @pago_factura.monto_pago } }

...
class RepuestoServiciosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create repuesto_servicio" do
    assert_difference('RepuestoServicio.count') do
      post repuesto_servicios_url, params: { repuesto_servicio: { category_id: @repuesto_servicio.category_id, codigo: @repuesto_servicio.codigo, costo: @repuesto_servicio.costo, descripcion: @repuesto_servicio.descripcion, precio_venta: @repuesto_servicio.precio_venta, stock: @repuesto_servicio.stock } }
    end
  ...
  test "should update repuesto_servicio" do
    patch repuesto_servicio_url(@repuesto_servicio), params: { repuesto_servicio: { category_id: @repuesto_servicio.category_id, codigo: @repuesto_servicio.codigo, costo: @repuesto_servicio.costo, descripcion: @repuesto_servicio.descripcion, precio_venta: @repuesto_servicio.precio_venta, stock: @repuesto_servicio.stock } }

class MecanicosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @mecanico.save
        format.html { redirect_to mecanicos_url, notice: 'Mecánico creado con éxito.' }
  ...
  def update
    respond_to do |format|
      if @mecanico.update(mecanico_params)
        format.html { redirect_to mecanicos_url, notice: 'Mecánico actualizado con éxito.' }
  ...
  def destroy
    @mecanico.destroy
    respond_to do |format|
      format.html { redirect_to mecanicos_url, notice: 'Mecánico eliminado con éxito.' }
  ...
  private
    ...
    def mecanico_params
      params.require(:mecanico).permit(:nombre)
    end
end

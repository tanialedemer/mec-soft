class EstadosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @estado.save
        format.html { redirect_to estados_url, notice: 'Estado creado con éxito.' }
  ...
  def update
    respond_to do |format|
      if @estado.update(estado_params)
        format.html { redirect_to estados_url, notice: 'Estado actualizado con éxito.' }
  ...
  def destroy
    @estado.destroy
    respond_to do |format|
      format.html { redirect_to estados_url, notice: 'Estado eliminado con éxito.' }
